...
class alphaPlastic(FoamFile):
    """
    Representa el archivo 'alphaPlastic' de OpenFOAM, utilizando el motor
    de plantillas Jinja2 para generar su contenido.
    """
    def __init__(self, second_part=None):
        if second_part != None:
            name_aux = "alphaPlastic" + "." + second_part
        else:
            name_aux = "alphaPlastic"
    ...
    def _get_string(self) -> str:
        ...
        template = self.jinja_env.get_template("alphaPlastic_template.jinja2")
        context = {
    ...
    def get_editable_parameters(self):
        ...
        return {
            'internalField': {
                'label': 'InternalField (alphaPlastic)',
                'tooltip': 'Define el valor inicial de alphaPlastic en todo el dominio (0 a 1).',
